...
This module provides a comprehensive interface for face detection, recognition,
and encoding using the dlib library. It serves as the core computer vision
component for facial recognition operations.

Key Features:
    - Face detection using HOG-based detector
    - 68-point facial landmark detection
    - Deep learning-based face encoding generation
    - Distance-based face comparison utilities
...
Model Files Required:
    ...
    - dlib_face_recognition_resnet_model_v1.dat: Face encoding model
"""
...
landmark_predictor_model_path = './models/shape_predictor_68_face_landmarks.dat'
facial_landmark_predictor = dlib.shape_predictor(landmark_predictor_model_path)

# Load face recognition model
face_recognition_model_path = './models/dlib_face_recognition_resnet_model_v1.dat'
face_encoder_model = dlib.face_recognition_model_v1(face_recognition_model_path)
...
def _raw_face_landmarks(face_image, face_locations=None):
    ...
    return [facial_landmark_predictor(face_image, face_location) for face_location in face_locations]
...
def face_encodings(face_image, known_face_locations=None, num_jitters=1):
    ...
    return [np.array(face_encoder_model.compute_face_descriptor(face_image, raw_landmark_set, num_jitters)) for raw_landmark_set in raw_landmarks]
